...
glslc.exe -I "%SCRIPT_DIR%\bindless.glsl" -I "%SCRIPT_DIR%\16bit_push_constants.glsl" -fshader-stage=vertex "%SCRIPT_DIR%\env_mapping_phong.vert.glsl" -O -o "%SCRIPT_DIR%\env_mapping_phong.vert.spv"
glslc.exe -I "%SCRIPT_DIR%\bindless.glsl" -I "%SCRIPT_DIR%\16bit_push_constants.glsl" -fshader-stage=frag "%SCRIPT_DIR%\env_mapping_phong.frag.glsl" -O -o "%SCRIPT_DIR%\env_mapping_phong.frag.spv"

glslc.exe -I "%SCRIPT_DIR%\bindless.glsl" -I "%SCRIPT_DIR%\16bit_push_constants.glsl" -fshader-stage=vertex "%SCRIPT_DIR%\pbr_env_mapping.vert.glsl" -O -o "%SCRIPT_DIR%\pbr_env_mapping.vert.spv"

glslc.exe -I "%SCRIPT_DIR%\bindless.glsl" -I "%SCRIPT_DIR%\16bit_push_constants.glsl" -fshader-stage=vertex "%SCRIPT_DIR%\shader_pbr.vert.glsl" -O -o "%SCRIPT_DIR%\shader_pbr.vert.spv"
...
glslc.exe -I "%SCRIPT_DIR%\bindless.glsl" -I "%SCRIPT_DIR%\16bit_push_constants.glsl" -fshader-stage=frag "%SCRIPT_DIR%\shader_pbr.frag.glsl" -O -o "%SCRIPT_DIR%\shader_pbr.frag.spv"